...
public class BuscarPaciente extends javax.swing.JInternalFrame {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(empresaLbl, javax.swing.GroupLayout.DEFAULT_SIZE, 247, Short.MAX_VALUE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(empresaLbl, javax.swing.GroupLayout.PREFERRED_SIZE, 16, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void buscarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarBtnActionPerformed
        ...
        Paciente paciente = obj.buscarPaciente(cedula);

        if (paciente != null) {
            nombreLbl.setText(paciente.getNombreCompleto());
            cedulaLbl.setText(paciente.getNumeroCedula());
            edadLbl.setText(paciente.getEdad()+"");
            empresaLbl.setText(paciente.getEmpresa());
        } else {
